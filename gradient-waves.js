// GradientWaves — vanilla-JS port of the React Bits component.
// Dependency: ogl (vendored locally as ./ogl.mjs, loaded via importmap).
// Faithful to the original shader/uniforms; React hooks replaced by a plain init().
...
export function initGradientWaves(container, props = {}) {
  const {
    horizonColor = '#5227FF',
    waveColor = '#FF9FFC',
    crestColor = '#FFFFFF',
